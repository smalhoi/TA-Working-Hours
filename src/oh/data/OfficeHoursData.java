...
public class OfficeHoursData implements AppDataComponent {
    ...
    public SiteData siteData = new SiteData();
    public SyllabusData syllabusData = new SyllabusData();
    public MeetingTimesData meetingTimesData = new MeetingTimesData();
    public ScheduleData scheduleData = new ScheduleData();
    // --------------------------------------------------------------------------------------------
    
    // THESE ARE ALL THE TEACHING ASSISTANTS
    public HashMap<TAType, ArrayList<TeachingAssistantPrototype>> allTAs;

    // NOTE THAT THIS DATA STRUCTURE WILL DIRECTLY STORE THE
    // DATA IN THE ROWS OF THE TABLE VIEW
    ObservableList<TeachingAssistantPrototype> teachingAssistants;
    public ObservableList<TimeSlot> officeHours;    
