...
public class OfficeHoursFiles implements AppFileComponent {
	...
	JsonObject all_json = loadJSONFile(filePath);
        JsonObject json = all_json.getJsonObject("OfficeHours");
	...
	String startHour = json.getString(JSON_START_HOUR);
        ...
        dataManager.siteData.loadJson(all_json.getJsonObject("Site"));
        dataManager.syllabusData.loadJson(all_json.getJsonObject("Syllabus"));
        dataManager.meetingTimesData.loadJson(all_json.getJsonObject("MeetingTimes"));
        dataManager.scheduleData.loadJson(all_json.getJsonObject("Schedule"));
    }
	...
	JsonObject dataManagerJSO = Json.createObjectBuilder()
                ...
                .add("Site", dataManager.siteData.toJson())
                .add("Syllabus", dataManager.syllabusData.toJson())
                .add("MeetingTimes", dataManager.meetingTimesData.toJson())
                .add("Schedule", dataManager.scheduleData.toJson())
                .build();
